...
#' @param sammp identifier for your Kc reference data used in the output names.
#' @param K Precalculated constants for each cn state.
#' @inheritParams make_Kc
#' @export
#' @examples
#' data("ss")
...
conumee_kc<-function(ID,ss,ref_genes="paper",conumee.folder="analysis/CONUMEE",seg.folder = "Segments",
                     log2r.folder = "log2r",
